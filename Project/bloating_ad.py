...
class Bloating_ad(QWidget):
    def __init__(self, xpos, ypos, title):
        super(Bloating_ad, self).__init__()
    ...
    def makeWin(self, xpos, ypos, title):
        self.setGeometry(xpos, ypos, 340, 510)
        self.setWindowTitle(title)
        label = QLabel(self)
        pixmap = QPixmap('img/bloating_ad.png')
...
if __name__ == '__main__':
    ...
    win1 = Bloating_ad(630, 10, "Advertisement")
    win1.show()
    sys.exit(app.exec_())
